...
async function main() {
  ...
  console.log(`  Region: Canada (Central)`);
  ...
  const poolerUri = `postgresql://postgres.${ref}:${encodeURIComponent(DB_PASSWORD)}@aws-0-ca-central-1.pooler.supabase.com:6543/postgres`;
